package com.projectname.applicationanme.ui.viewmodels.loginviewmodel;
...
public class LoginFormViewModel extends ViewModel {
    ...
    private final MutableLiveData<String> checkBoxRecuerdame;
    ...
    public LoginFormViewModel(){
        ...
        checkBoxRecuerdame = new MutableLiveData<>();
        checkBoxRecuerdame.setValue("Recuerdame");
